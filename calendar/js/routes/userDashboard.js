...
function UserDashboard() {
    ...
    const renderCommunicationTooltip = (communication) => {
        return ( <
            ...
            p > Date: {
                new Date(communication.timestamp).toLocaleDateString()
            } < /p> <
            p > Notes: {
                communication.notes || "No notes"
            } < /p> <
            p > Sequence: {
    ...
    return ( <
        ...
        section className = "companies-grid" > {
            state.companies.map((company) => {
                ...
                return ( <
                    ...
                    className = {
                        `company-row ${getCompanyStatus(company)}`
                    } >
                    <
                    input type = "checkbox"
                    checked = {
        ...
        { /* Communication Modal remains largely unchanged */ } {
            communicationModal && ( <
                ...
                >
                <
                textarea placeholder = "Communication Notes"
                value = {
